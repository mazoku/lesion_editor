...
#
# Created: Tue Oct 13 14:05:43 2015
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.view_L_BTN = QtGui.QPushButton(self.frame_R)
        ...
        self.view_L_BTN.setMinimumSize(QtCore.QSize(30, 30))
        self.view_L_BTN.setMaximumSize(QtCore.QSize(30, 16777215))
        ...
        self.horizontalLayout_2.addWidget(self.view_L_BTN)
        self.show_im_L_BTN = QtGui.QPushButton(self.frame_R)
        ...
        self.show_im_L_BTN.setMinimumSize(QtCore.QSize(30, 30))
        self.show_im_L_BTN.setMaximumSize(QtCore.QSize(30, 16777215))
        ...
        self.horizontalLayout_2.addWidget(self.show_im_L_BTN)
        self.show_labels_L_BTN = QtGui.QPushButton(self.frame_R)
        ...
        self.show_labels_L_BTN.setMinimumSize(QtCore.QSize(30, 30))
        self.show_labels_L_BTN.setMaximumSize(QtCore.QSize(30, 16777215))
        ...
        self.horizontalLayout_2.addWidget(self.show_labels_L_BTN)
        self.show_contours_L_BTN = QtGui.QPushButton(self.frame_R)
        ...
        self.show_contours_L_BTN.setMinimumSize(QtCore.QSize(30, 30))
        self.show_contours_L_BTN.setMaximumSize(QtCore.QSize(30, 16777215))
        ...
        self.horizontalLayout_2.addWidget(self.show_contours_L_BTN)
        ...
        self.horizontalLayout_2.addWidget(self.figure_L_CB)
        ...
        self.view_R_BTN = QtGui.QPushButton(self.frame_R)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.view_R_BTN.sizePolicy().hasHeightForWidth())
        self.view_R_BTN.setSizePolicy(sizePolicy)
        self.view_R_BTN.setMinimumSize(QtCore.QSize(30, 30))
        self.view_R_BTN.setMaximumSize(QtCore.QSize(30, 16777215))
        ...
        self.horizontalLayout_4.addWidget(self.view_R_BTN)
        self.show_im_R_BTN = QtGui.QPushButton(self.frame_R)
        ...
        self.show_im_R_BTN.setMinimumSize(QtCore.QSize(30, 30))
        self.show_im_R_BTN.setMaximumSize(QtCore.QSize(30, 16777215))
        ...
        self.horizontalLayout_4.addWidget(self.show_im_R_BTN)
        self.show_labels_R_BTN = QtGui.QPushButton(self.frame_R)
        ...
        self.show_labels_R_BTN.setMinimumSize(QtCore.QSize(30, 30))
        self.show_labels_R_BTN.setMaximumSize(QtCore.QSize(30, 16777215))
        ...
        self.horizontalLayout_4.addWidget(self.show_labels_R_BTN)
        self.show_contours_R_BTN = QtGui.QPushButton(self.frame_R)
        ...
        self.show_contours_R_BTN.setMinimumSize(QtCore.QSize(30, 30))
        self.show_contours_R_BTN.setMaximumSize(QtCore.QSize(30, 16777215))
        ...
        self.horizontalLayout_4.addWidget(self.show_contours_R_BTN)
        ...
        self.horizontalLayout_4.addWidget(self.figure_R_CB)
        ...
        self.slice_number_L_LBL = QtGui.QLabel(self.frame_R)
        self.slice_number_L_LBL.setMinimumSize(QtCore.QSize(35, 0))
        ...
        self.horizontalLayout_11.addWidget(self.slice_number_L_LBL)
        self.slice_L_SB = QtGui.QScrollBar(self.frame_R)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.MinimumExpanding, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.slice_L_SB.sizePolicy().hasHeightForWidth())
        self.slice_L_SB.setSizePolicy(sizePolicy)
        self.slice_L_SB.setMinimumSize(QtCore.QSize(50, 0))
        self.slice_L_SB.setMaximumSize(QtCore.QSize(100, 15))
        self.slice_L_SB.setOrientation(QtCore.Qt.Horizontal)
        self.slice_L_SB.setObjectName(_fromUtf8("slice_L_SB"))
        self.horizontalLayout_11.addWidget(self.slice_L_SB)
        ...
        self.slice_C_SB.setMinimumSize(QtCore.QSize(100, 0))
        ...
        self.slice_R_SB = QtGui.QScrollBar(self.frame_R)
        self.slice_R_SB.setEnabled(True)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.MinimumExpanding, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.slice_R_SB.sizePolicy().hasHeightForWidth())
        self.slice_R_SB.setSizePolicy(sizePolicy)
        self.slice_R_SB.setMinimumSize(QtCore.QSize(50, 0))
        self.slice_R_SB.setMaximumSize(QtCore.QSize(100, 16777215))
        self.slice_R_SB.setOrientation(QtCore.Qt.Horizontal)
        self.slice_R_SB.setObjectName(_fromUtf8("slice_R_SB"))
        self.horizontalLayout_11.addWidget(self.slice_R_SB)
        self.slice_number_R_LBL = QtGui.QLabel(self.frame_R)
        self.slice_number_R_LBL.setMinimumSize(QtCore.QSize(35, 0))
        self.slice_number_R_LBL.setMaximumSize(QtCore.QSize(60, 16777215))
        self.slice_number_R_LBL.setLayoutDirection(QtCore.Qt.LeftToRight)
        ...
        self.horizontalLayout_11.addWidget(self.slice_number_R_LBL)
